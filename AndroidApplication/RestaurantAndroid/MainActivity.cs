...
using RestauranDroid;
using System;
using AndroidApplication;

namespace RestaurantAndroid
{
    [Activity(Label = "RestaurantAndroid", MainLauncher = true, Icon = "@drawable/icon")]
    public class MainActivity : Activity
    {

        public static readonly EndpointAddress EndPoint = new EndpointAddress("http://192.168.1.143:9608/HelloWorldService.svc");

        private AndroidApplicationServiceClient _client;
    ...
    _sayHelloWorldTextView = FindViewById<TextView>(Resource.Id.sayHelloWorldTextView);
        ...
        private void InitializeHelloWorldServiceClient()
        {
            ...
            _client = new AndroidApplicationServiceClient(binding, EndPoint);
